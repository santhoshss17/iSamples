...
permittedArrowDirections:(UIPopoverArrowDirection)permittedArrowDirections
	...
	if ((self = [super initWithFrame:CGRectZero])) {
		...
		self.bgImage = [theImage stretchableImageWithLeftCapWidth:properties.leftBgCapSize topCapHeight:properties.topBgCapSize];
...
- (void)drawRect:(CGRect)rect {
	[self.bgImage drawInRect:bgRect blendMode:kCGBlendModeNormal alpha:1.0];
